package com.zhukai.ribbon.controller;

import com.zhukai.ribbon.entity.User;
...
public class UserController {
    ...
    private static final String SERVER_URL = "http://server-provider";

    @GetMapping("/index")
    public String index() {
        return restTemplate.getForObject(SERVER_URL + "/user/index", String.class);
    }
